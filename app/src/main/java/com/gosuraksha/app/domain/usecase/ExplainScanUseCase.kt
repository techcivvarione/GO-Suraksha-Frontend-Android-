...
) : UseCase<String, DomainResult<AiExplainResult>>(dispatchers) {
    override suspend fun execute(params: String): DomainResult<AiExplainResult> {
        return repository.explain(params)
    }
}
